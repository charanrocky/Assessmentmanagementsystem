...
export const assessmentData = [
  // Sample Dataset 1: Health & Fitness Assessment (as_hr_02)
  {
    ...
    reportLink:
      "https://storage.googleapis.com/allycare-prod.appspot.com/fWOr2t8S94e0BIIlcUKkh7m629d2/GthcXa9eHlfnU2BGIIerrAoDZMH2/-OK76AihRKe9xdHFWjuY.pdf?GoogleAccessId=...",
    ...
    vitalsMap: {
      ...
      metadata: {
        cardiovascular: { cardiac_out: 6.3, map: 96, prq: 3.57 },
        fps: 114,
        glucose_info: {
        ...
        heart_scores: {
          ...
          sdnn: 45.88,
          stress_index: 1.4,
          zone_details: { highZoneRange: 94, lowZoneRange: "--", zone: "Rest" },
        },
  ...
  // Sample Dataset 2: Cardiac Assessment (as_card_01)
  {
    ...
    laterPainScore: "pending",
    reportLink:
      "https://firebasestorage.googleapis.com/v0/b/rootallyai.appspot.com/o/reports%2FW2g8IThefhPc3SNAv46x2TT3hOB3%2FzHSezoe7w3exoakaC4dGGMneB0u2%2Fgugh_7713.pdf?alt=media&token=...",
    timeElapsed: 67,
    ...
    vitalsMap: {
      ...
      health_risk_score: 16,
      metadata: {
        cardiovascular: { cardiac_out: 5.68, map: 95.33, prq: 3.47 },
        fps: 114,
        glucose_info: {
